...
# --- 2. 您的具体路径 (直接指定) ---
# (这是为 'cc' 视图 和 'train' 数据集设置的)

# 2a. 原始全尺寸图像
FULL_IMAGE_DIR = '/kaggle/input/breast/data/cc_view/images/train'

# 2b. 原始 Ground Truth 标签
GT_LABEL_DIR = '/kaggle/input/breast/data/cc_view/labels/train'

# 2c. 您的YOLO *预测* 标签
YOLO_PRED_LABEL_DIR = '/kaggle/input/siamesedata/siameseD/train/cc/labels' 

# 2d. 输出路径 (!! 重要 !!)
# Kaggle的 /kaggle/input 是只读的, 您必须写入 /kaggle/working/
# 我们将数据保存在这里: /kaggle/working/processed_data/train/cc
OUTPUT_DIR = '/kaggle/working/processed_data/train/cc'
