...
SPLIT = 'train'
# --- 调整K值 (每张图像保留的阴性样本数) ---
K_NEGATIVE_PATCHES = 2 
IOU_THRESHOLD = 0.5


# --- 2. 您的具体路径 (直接指定) ---
# (这是为 'mlo' 视图 和 'train' 数据集设置的)

# 2a. 原始全尺寸图像
FULL_IMAGE_DIR = '/kaggle/input/breast/data/mlo_view/images/train'

# 2b. 原始 Ground Truth 标签
GT_LABEL_DIR = '/kaggle/input/breast/data/mlo_view/labels/train'

# 2c. 您的YOLO *预测* 标签
YOLO_PRED_LABEL_DIR = '/kaggle/input/siamesedata/siameseD/train/mlo/labels' 

# 2d. 输出路径 (!! 重要 !!)
# Kaggle的 /kaggle/input 是只读的, 您必须写入 /kaggle/working/

OUTPUT_DIR = '/kaggle/working/processed_data/train/mlo'
