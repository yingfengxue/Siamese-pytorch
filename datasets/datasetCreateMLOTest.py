...
# --- 2. 您的具体路径 (直接指定) ---
# (这是为 'mlo' 视图 和 'test' 数据集设置的)

# 2a. 原始全尺寸图像
FULL_IMAGE_DIR = '/kaggle/input/breast/data/mlo_view/images/test'

# 2b. 原始 Ground Truth 标签
GT_LABEL_DIR = '/kaggle/input/breast/data/mlo_view/labels/test'

# 2c. 您的YOLO *预测* 标签
YOLO_PRED_LABEL_DIR = '/kaggle/input/siamesedata/siameseD/test/mlo/labels' 

# 2d. 输出路径 (!! 重要 !!)
# Kaggle的 /kaggle/input 是只读的, 您必须写入 /kaggle/working/

OUTPUT_DIR = '/kaggle/working/processed_data/test/mlo'
